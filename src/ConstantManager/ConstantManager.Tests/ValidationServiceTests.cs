...
namespace ConstantManager.Tests
{
    public class ValidationServiceTests
    {
        ...
        {
            // Arrange & Act
            var (isValid, errorMessage) = Validator.ValidateLogicalName(new string('あ', 65));
        ...
        {
            // Arrange & Act
            var (isValid, errorMessage) = Validator.ValidateLogicalName(new string('あ', 64));
        ...
        {
            // Arrange & Act
            var (isValid, errorMessage) = Validator.ValidateDescription(new string('説', 257));
        ...
        {
            // Arrange & Act
            var (isValid, errorMessage) = Validator.ValidateDescription(new string('説', 256));
